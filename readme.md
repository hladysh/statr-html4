...
<ol>
	<li><a href="https://github.com/hladysh/statr-html4/archive/master.zip">Download</a> <strong>OptimizedHTML 4</strong> from GitHub;</li>
...
<ul>
	...
	<li><strong>gulp build</strong> project deployment on folder dist;</li>
</ul>
